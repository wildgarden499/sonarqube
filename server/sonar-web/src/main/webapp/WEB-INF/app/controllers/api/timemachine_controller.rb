  ...
  def index
    begin
      ...
      unless @metrics.empty?
        sql_conditions = ['snapshots.component_uuid=:rid AND snapshots.status=:status AND project_measures.rule_id IS NULL AND project_measures.rule_priority IS NULL AND project_measures.person_id IS NULL']
