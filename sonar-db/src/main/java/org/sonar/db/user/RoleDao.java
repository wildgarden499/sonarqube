...
public class RoleDao implements Dao {
  ...
  public List<UserRoleDto> selectUserPermissionsByPermissionAndUserId(DbSession dbSession, String permission, long userId) {
    return mapper(dbSession).selectUserPermissionsByPermissionAndUserId(permission, userId);
  }
