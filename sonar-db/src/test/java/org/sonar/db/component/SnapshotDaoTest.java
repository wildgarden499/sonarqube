...
public class SnapshotDaoTest {
  ...
  @Test
  public void lastSnapshots_with_empty_component_ids() {
    List<SnapshotDto> result = underTest.selectLastSnapshotByComponentIds(dbSession, emptyList());
  ...
  public void lastSnapshots() {
    ...
    List<SnapshotDto> result = underTest.selectLastSnapshotByComponentIds(dbSession, newArrayList(firstProject.getId(), secondProject.getId()));
